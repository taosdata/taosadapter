...
func TestReadBlock(t *testing.T) {
	...
	sql := fmt.Sprintf("insert into test_block_raw.t0 using test_block_raw.all_type tags('{\"a\":1}') values"+
		...
		"('%s',null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null)"+
		"('%s',true,%d,%d,%d,%d,%d,%d,%d,%v,%f,%f,'b','n','test_varbinary','point(100 100)','123.456','123456.456')",
