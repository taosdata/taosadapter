...
func TaosaTMQCommitOffset(tmqThread unsafe.Pointer, tmq unsafe.Pointer, topic string, vgID, offset int64, caller cgo.Handle) {
	topicName := C.CString(topic)
...
func TaosaTMQCommitted(tmqThread unsafe.Pointer, tmq unsafe.Pointer, topic string, vgID int64, caller cgo.Handle) {
	topicName := C.CString(topic)
...
func TaosaTMQPosition(tmqThread unsafe.Pointer, tmq unsafe.Pointer, topic string, vgID int64, caller cgo.Handle) {
	topicName := C.CString(topic)
